...
curl --header "Content-Type: application/json" \
  --request POST \
  --data "{\"content_id\":$xarr_id,\"content_name\":\"$content_name\",\"content_category\":\"Movies\",\"torrent_linker_id\":\"$torrent_linker_id\",\"nzb_linker_id\":\"$nzb_linker_id\",\"grabbed_quality\":\"$grabbed_quality\",\"grabbed_size\":\"$grabbed_size\",\"imdb_id\":\"$imdb_id\"}" \
