<template>
    <section class="container mx-auto mt-4">
        <section class="menu" :class="expandMenu?'expanded':''">
            ...
            <router-link :to="{name: 'logout'}" class="route-item ml-auto logout align-middle flex items-center">
...
<style scoped>
.route-item {
    @apply pl-5 pr-5 pt-6 pb-6 text-xl cursor-pointer hover:bg-yellow-400 focus:bg-yellow-400 uppercase text-white;
}
.reg-route {
    @apply hidden;
    @apply xl:block;
