        ...
        <div class="modal-card login-container">
            ...
            >
                <b-button
                    ...
                    @click="authenticate"
                    type="is-primary"
                    >{{ firstRun ? "Create Account" : "Login" }}</b-button
                >
            </footer>
        </div>
    </div>
...
export default {
    ...
    methods: {
        authenticate: function() {
            ...
            axios
                .post("/auth/" + (this.firstRun ? "signup" : "login"), creds)
                .then((response) => {
                    /* eslint-disable */
                    this.checkAuthorizedToken(response);
                    console.log('check me')
                })
                .catch((error) => {
                    this.checkUnauthorizedToken(error, false);
                    Snackbar.open({
