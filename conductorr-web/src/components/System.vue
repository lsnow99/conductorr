<template>
    <div class="container">
        <div class="setting-header"><img :src="require('@/assets/conductorr.svg')" class="setting-logo"> System</div>
...
export default {
    ...
    data() {
        return {
            ...
            health: {sonarr: true, radarr: false, filebot: true, plex: true}
        }
    },
    methods: {
        checkUpdates(){
            this.checkingUpdates = true
            axios.post("/backend/checkUpdates/" + this.service, this.configObj)
            .then(() => {
                Snackbar.open({
