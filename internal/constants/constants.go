...
// FilebotConfig the default settings for filebot + descriptions
var FilebotConfig = []schema.Configurator{
	...
	{Label: "Filebot Namespace", Placeholder: "filebot", Description: "Filebot Kubernetes namespace", Property: "fb_namespace", StringValue: "", Datatype: "string"},
	{Label: "Filebot Deployment Name", Placeholder: "filebot", Description: "Filebot Kubernetes deployment name", Property: "fb_deployment_name", StringValue: "", Datatype: "string"},
...
// SonarrConfig the default settings for sonarr + descriptions
...
// RadarrConfig the default settings for radarr + descriptions
...
// PlexConfig the default settings for plex + descriptions
