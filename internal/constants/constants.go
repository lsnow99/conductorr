...
var FilebotConfig = []schema.Configurator {
	...
	{Label:"Min File Size", Placeholder:"0", Description:"Only process video files larger than the given number (in bytes). Defaults to 50 MB", Property:"fb_min_file_size", StringValue:"", IntValue:-1, Datatype:"int"},
	{Label:"Min File Length (ms)", Placeholder:"0", Description:"Only process videos longer than the given number (in milliseconds). Defaults to 10 minutes", Property:"fb_min_length_ms", StringValue:"", IntValue:-1, Datatype:"int"},
}